...
openEO specifies an open application programming interface (API) that connects clients written in languages such as R, Python, and JavaScript to big Earth observation cloud back-ends in a simple and unified way.
