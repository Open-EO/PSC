...
The Specifications cater for different user audiences: openEO has a wider scope of features, while OGC API - Processes only covers processing and additional features require the integration of other OGC API specifications.
...
A detailed comparison of the openEO API and the OGC API - Processes can be found here:
